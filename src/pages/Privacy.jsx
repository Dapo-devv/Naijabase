      ...
      <div className="space-y-6">
        <section>
          ...
          <p className="text-gray-600 dark:text-gray-300">
            ...
            name, email address, preferred currency, and the financial data you
            choose to enter into the app (expenses, sales, trips, plans).
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-gray-600 dark:text-gray-300">
            TrackCash uses your data to provide expense tracking, spending
            plans, business finance tools, and financial summaries. We do not
        ...
        <section>
          ...
          <p className="text-gray-600 dark:text-gray-300">
            ...
            internet is 100% secure. You can log out from all devices at any
            time via your Profile settings.
          </p>
        </section>

        <section>
          <h2 className="text-xl font-bold mb-2">4. International Users</h2>
          <p className="text-gray-600 dark:text-gray-300">
            TrackCash is available worldwide. Your data may be processed and
            stored in servers located outside your country of residence. By
        ...
        <section>
          ...
          <p className="text-gray-600 dark:text-gray-300">
            ...
            time via your Profile settings or by contacting us directly.
          </p>
        </section>

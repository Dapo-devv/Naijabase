          ...
          {loggedIn ? (
            <>
              ...
              {isAdmin && (
                <Link
                  to="/admin"
                  className={`${linkBase} ${isActive("/admin")} text-red-600 hover:bg-red-50 border border-red-200`}
                >
              ...
              <button
                ...
                className={`${linkBase} text-red-600 hover:bg-red-50 flex items-center gap-1.5`}
              >
            ...
            <>
              ...
              <Link
                to="/register"
                className="px-4 py-2 rounded-lg text-sm font-semibold bg-primary text-white hover:bg-primary-600 transition-colors"
              >
                Register
              </Link>
            </>

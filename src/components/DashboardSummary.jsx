  ...
  const cardConfigs = [
    {
      key: "spend",
      label: "Monthly Spend",
      value: format(monthlySpend),
      sub: `Today: ${format(todaySpend)}`,
      icon: ShoppingCart,
    ...
    },
    {
      ...
      label: "Spending Plan",
      value: latestPlan
        ? format(latestPlan.totalIncome - latestPlan.totalAllocated)
        : "No plan",
      sub: latestPlan
        ...
        <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl p-5 border border-gray-100 dark:border-gray-700 shadow-sm">
          ...
          <div className="space-y-2">
            ...
            <div className="flex justify-between text-sm border-t border-gray-200 dark:border-gray-600 pt-2">
              ...
              >
                {format(monthlySales - monthlySpend)}
              </span>
            </div>
          </div>
        </div>
